            ...
            <nav className="bg-blue-700 z-40 dark:bg-gray-900 sticky w-full top-0 left-0 border-b border-white dark:border-gray-600">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="flex md:order-2">
                        <button type="button" className="text-black md:mx-2 bg-yellow-300 hover:bg-yellow-400 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-yellow-300 dark:hover:bg-yellow-400 dark:focus:ring-yellowbg-yellow-300">Login</button>
                        <button type="button" className="text-black md:mx-2 bg-white hover:bg-black hover:text-white focus:ring-4 focus:outline-none focus:ring-white font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-white dark:hover:bg-black dark:hover:text-white dark:focus:ring-yellowbg-white">SignUp</button>

                        <button type="button" class="relative inline-flex items-center p-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:outline-none active:bg-black">
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-[700px] md:order-1" id="navbar-sticky">
